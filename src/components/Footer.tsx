...
const Footer: React.FC<FooterProps> = ({ neighborhoodName }) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://www.instagram.com/century21_alpha/" className="text-gray-300 hover:text-[#BEAF87] transition-colors">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.linkedin.com/company/century21-alpha/" className="text-gray-300 hover:text-[#BEAF87] transition-colors">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
